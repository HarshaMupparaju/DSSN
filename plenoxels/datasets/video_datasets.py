...
import numpy as np
import torch
from .loding_csv import OF_paths
from .base_dataset1 import BaseDataset
from .data_loading import parallel_load_images
from .data_loading import _load_video_1cam
from .intrinsics1 import Intrinsics
from .llff_dataset1 import load_llff_poses_helper
...
class Video360Dataset(BaseDataset):
    ...
    def __init__(self,
        ...
        if dset_type == "llff":
            ...
            timestamps = (timestamps.float() / timestamps.max()) * 2 - 1
...
def load_llffvideo_poses(datadir: str,
                         downsample: float,
                         split: str,
                         near_scaling: float,data_part =2) -> Tuple[
