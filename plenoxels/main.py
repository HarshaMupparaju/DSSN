...
from plenoxels.tr_ts_data_loading  import tr_ts_load_data
...
def main():
    ...
    p.add_argument('--log-dir', type=str, default=None)#'/log/realdynamic/cutbee_hybrid'
    ...
    if validate_only:
        trainer.validate()
       # trainer.validate_new(required_frame=50)  # checking on 0th known sparse flow points (test video is also video 1 used in training
    elif render_only:
